...
class NotificationService {
  constructor() {
    ...
    this.sendWhatsAppNotification = httpsCallable(functions, 'sendWhatsAppNotification');
    this.sendEmailNotification = httpsCallable(functions, 'sendEmailNotification');
    this.createInAppNotification = httpsCallable(functions, 'createInAppNotification');
    this.sendBulkNotifications = httpsCallable(functions, 'sendBulkNotifications');
